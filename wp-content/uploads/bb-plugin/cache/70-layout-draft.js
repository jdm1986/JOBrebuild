...
var wpAjaxUrl='http://localhost/JOBrebuild/wp-admin/admin-ajax.php';var flBuilderUrl='http://localhost/JOBrebuild/wp-content/plugins/beaver-builder-lite-version/';var FLBuilderLayoutConfig={anchorLinkAnimations:{duration:1000,easing:'swing',offset:100},paths:{pluginUrl:'http://localhost/JOBrebuild/wp-content/plugins/beaver-builder-lite-version/',wpAjaxUrl:'http://localhost/JOBrebuild/wp-admin/admin-ajax.php'},breakpoints:{small:768,medium:992},waypoint:{offset:80}};(function($){if(typeof FLBuilderLayout!='undefined'){return;}
...
{var field=$(this);field.removeClass('fl-form-error');field.siblings('.fl-form-error-message').hide();}};$(function(){FLBuilderLayout.init();});})(jQuery);var rentals=querySelector("#menu-item-193 a");var logo=document.createElement("img");logo.setAttribute("src","http://localhost/JOBrebuild/wp-content/uploads/2018/04/logo3.png");logo.setAttribute("height","768");logo.setAttribute("width","1024");logo.setAttribute("alt","logo");logo.appendAfter(rentals);;if(typeof FLBuilder!=='undefined'&&typeof FLBuilder._renderLayoutComplete!=='undefined')FLBuilder._renderLayoutComplete();