...
{var field=$(this);field.removeClass('fl-form-error');field.siblings('.fl-form-error-message').hide();}};$(function(){FLBuilderLayout.init();});})(jQuery);var rentalsli=document.querySelector("#menu-item-193");rentalsli.after("test");