    ...
    */
        ...
        <div id="post-body" class="metabox-holder columns-2" >  
            ...
            <div id="postbox-container-1" class="postbox-container" > 
                ...
                <div class="postbox"> 
                 ...
                 <div class="postbox"> 
                          <h3 class="hndle"><span></span>WordPress Map Plugin</h3> 
                          <div class="inside">
                               <center><a href="http://www.shareasale.com/m-pr.cfm?merchantID=25608&userID=675922&productID=536585569" title="Map Plugin" target="_blank"><img src="<?php echo plugins_url( 'images/ChimeraMapMe-247x180.jpg', __FILE__ );?>" width="250"  border="0"></a></center>
                        ...
                        <div id="post-body-content">
                            ...
                            <script>
                             function clickedItem(){ 
                                              ...
                                              $n(".<?php echo $rand_lightbox_rel;?>").fancybox_crl({
                                                'overlayColor':'#000000',
                                                 'padding': 10,
                                                 'autoScale': true,
                                                 'autoDimensions':true,
    ...
    <div style="width: auto;postion:relative" id="divSliderMain">
        ...
        <script>
         function clickedItem(){ 
                          ...
                          $n(".<?php echo $rand_lightbox_rel;?>").fancybox_crl({
                            'overlayColor':'#000000',
                             ...
                             'height' : 350,
                             'titleFormat': function(title, currentArray, currentIndex, currentOpts) {
                                 var currtElem = $n('.responsiveContinuousCarousel a[href="'+currentOpts.href+'"]');
         ...
         <?php endif;?>
        <div class="responsiveContinuousCarousel" style="margin-top: <?php echo $topMargin;?> !important;visibility: hidden;">
            <?php
                global $wpdb;          
                $imageheight=$settings['imageheight'];
                $imagewidth=$settings['imagewidth'];
