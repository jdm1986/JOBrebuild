...
function vw_lawyer_attorney_widgets_init() {
	...
	register_sidebar( array(
		...
		'description'   => __( 'Appears on footer 1', 'vw-lawyer-attorney' ),
		'id'            => 'footer-1',
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h3 class="widget-title">',
	...
	register_sidebar( array(
		...
		'description'   => __( 'Appears on footer 2', 'vw-lawyer-attorney' ),
		'id'            => 'footer-2',
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h3 class="widget-title">',
	...
	register_sidebar( array(
		...
		'description'   => __( 'Appears on footer 3', 'vw-lawyer-attorney' ),
		'id'            => 'footer-3',
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h3 class="widget-title">',
	...
	register_sidebar( array(
		...
		'description'   => __( 'Appears on footer 4', 'vw-lawyer-attorney' ),
		'id'            => 'footer-4',
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h3 class="widget-title">',
...
define('VW_LAWYER_ATTORNEY_SUPPORT','https://www.vwthemes.com/support/vw-theme/','vw-lawyer-attorney');
